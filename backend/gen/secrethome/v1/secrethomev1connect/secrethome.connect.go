...
const (
	...
	GreetServiceName = "secrethome.v1.GreetService"
)

// GreetServiceClient is a client for the secrethome.v1.GreetService service.
type GreetServiceClient interface {
	Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error)
}

// NewGreetServiceClient constructs a client for the secrethome.v1.GreetService service. By default,
...
func NewGreetServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GreetServiceClient {
	...
	return &greetServiceClient{
		greet: connect_go.NewClient[v1.GreetRequest, v1.GreetResponse](
			httpClient,
			baseURL+"/secrethome.v1.GreetService/Greet",
			opts...,
		),
	}
}
...
// Greet calls secrethome.v1.GreetService.Greet.
...
// GreetServiceHandler is an implementation of the secrethome.v1.GreetService service.
...
func NewGreetServiceHandler(svc GreetServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/secrethome.v1.GreetService/Greet", connect_go.NewUnaryHandler(
		"/secrethome.v1.GreetService/Greet",
		svc.Greet,
		opts...,
	))
	return "/secrethome.v1.GreetService/", mux
}
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect_go.Request[v1.GreetRequest]) (*connect_go.Response[v1.GreetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("secrethome.v1.GreetService.Greet is not implemented"))
}
